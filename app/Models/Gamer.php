...
class Gamer extends Model
{
  ...
  //adding user to our database when he/she create an account and sending a verification mail
  ...
  //verifying user from the link sent to his/her email and sending another link if link is broken
  ...
  //logging user and maintaining his/her session
  ...
  //sending recovery mail when user forgets password
  public static function recover(Request $request)
    ...
    //validating link to change password
    ...
    //updating password when user has forgotten password and was logged out
    ...
    //fetching user basic data using userid
    ...
    //changing profile picture of user and sending photo to aws bucket
