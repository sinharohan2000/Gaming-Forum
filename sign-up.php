...
echo "        </div>\n";
echo "      </form>\n";
echo "      <!--<button class=\"btn btn-outline-success my-2 my-sm-0 Login\" type=\"submit\"><a href=\"login.html\">login </a></button></button> -->\n";
echo "    </div>\n";
echo "  </nav>\n";
echo "\n";
...
echo "      <br>\n";
echo "      Already have an accout? <a href=\"login.html\">Login</a>\n";
echo "    </center>\n";
echo "\n";
echo "  </div>\n";
echo "\n";
